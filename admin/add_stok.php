                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Tambah Stok Buku </h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form>
                                ...
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Buku Masuk</label>
                                                <input type="text" id="input-username" class="form-control" placeholder="Buku Masuk ...">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-first-name">Model</label>
                                                <input type="text" id="input-first-name" class="form-control" placeholder="Model ...">
                                            </div>
                                        </div>
                                        <!-- <div class="col-lg-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-first-name">Seri / Nomor</label>
                                                <input type="text" id="input-first-name" class="form-control" placeholder="First name">
                                                <span class="h6 font-weight-300">ex : LA 100 387 561 - LA 100 387 650</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
